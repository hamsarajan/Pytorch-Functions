...
def conv2d(feature_map, in_channels, out_channels, size, stride, filter, bias):
    # filter, bias = prepare(size, out_channels, in_channels)
...
if __name__ == '__main__':
    ...
    my_out = conv2d(input, in_channels, out_channels, kernel_size, stride, filter, bias)
